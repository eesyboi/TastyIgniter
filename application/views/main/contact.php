	...
	<h2><?php echo $text_local; ?></h2>	
		...
		<div id="selectedLocation" class="left">
			<div id="restaurant-info">
				...
				<?php echo $distance; ?><br /><br />
		
				<span class="is-open"><?php echo $text_open_or_close; ?></span><br />
				<span class=""><?php echo $text_delivery; ?></span><br />
				<span class=""><?php echo $text_collection; ?></span>
		
				<div class="charges"><?php echo $text_charges; ?></div>
				<div class="review"><?php echo $text_reviews; ?></div>
			</div>
		...
		<div id="contactForm" class="right">
			<table class="form">
			<tr>
