	...
	<div id="header">
  	...
  	<ul>
		...
		<li><a href="<?php echo site_url('admin/menus'); ?>">Menus</a>
			<ul id="sub_nav">
				<li><a href="<?php echo site_url('admin/menus/options'); ?>">Options</a></li>
				<li><a href="<?php echo site_url('admin/categories'); ?>">Categories</a></li>
				<!--<li><a href="<?php echo site_url('admin/specials'); ?>">Specials</a></li>		
				<li><a href="<?php echo site_url('admin/quantities'); ?>">Quantities</a></li>-->
		...
		<li><a>Manage</a>
			<ul id="sub_nav">
				...
				<li><a href="<?php echo site_url('admin/staffs'); ?>">Staffs</a></li>
