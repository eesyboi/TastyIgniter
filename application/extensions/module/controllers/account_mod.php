...
class Account_mod extends MX_Controller {

	public function index() {
		$this->output->enable_profiler(TRUE); // for debugging profiler... remove later
		$this->lang->load('main/account');  														// loads language file
		
		if ( !file_exists('application/extensions/module/views/account_mod.php')) { 								//check if file exists in views folder
		...
		$this->load->view('module/account_mod', $data);
	}		
}