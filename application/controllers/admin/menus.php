...
class Menus extends MX_Controller {
	...
	public function index() {
		...
		if ( !file_exists('application/views/admin/menus.php')) { //check if file exists in views folder
	...
	public function edit() {
		...
		if ( !file_exists('application/views/admin/menus_edit.php')) { //check if file exists in views folder
			show_404(); // Whoops, show 404 error page!
		}
