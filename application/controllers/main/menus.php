...
class Menus extends MX_Controller {
	...
	public function index() {
		...
		if ( !file_exists('application/views/main/menus.php')) { 								// check if file exists in views folder
		...
		$content_data['button_right'] 		= '<a class="button" href='. $this->config->site_url("checkout") .'>'. $this->lang->line('button_continue') .'</a>';
	...
	public function write_review() {
		...
		if ( !file_exists('application/views/main/write_review.php')) { 						//check if file exists in views folder
			show_404(); // Whoops, show 404 error page!
		}
		...
		$data['ratings'] = array('1' => 'Bad', '2' => 'Worse', '3' => 'Good', '4' => 'Average', '5' => 'Excellent');
