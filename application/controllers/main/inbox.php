...
class Inbox extends MX_Controller {
	...
	public function index() {
		...
		if ( !file_exists('application/views/main/inbox.php')) { 								//check if file exists in views folder
	...
	public function view() {
		...
		if ( !file_exists('application/views/main/inbox_view.php')) { 							//check if file exists in views folder
			show_404(); 																		// Whoops, show 404 error page!
		}
