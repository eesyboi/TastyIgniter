...
class Reservations_model extends CI_Model {
	...
	public function checkAvailability($data = array()) {		
		...
		$available_tables = $this->checkTableSize($data['location_id'], $data['guest_num']);
		
		if (!empty($data) && !empty($available_tables) && isset($data['location_id'], $data['reserve_date'], $data['reserve_time'])) {
